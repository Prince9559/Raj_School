...
const OnpneRegistration = ({ handleNextStep }) => {
  ...
  return (
    <div className="px-4 lg:px-0 ex:w-full">
      ...
      <div className="text-sm text-[#343A78] font-bold bg-[#F5F7F9] py-2.5 px-4 flex flex-col items-start mb-1.25">
        <div className="flex items-center mb-2">
          ...
          />
          <label htmlFor="agree">
            I have read and agree to abide by the instructions mentioned above
