...
const UploadDocuments = ({ formData, setFormData, setUpload, upload,setIsAgree,cookies ,isUploadDocument }) => {

    console.log("isUploaded", upload);
    ...
    const handleChange = (e) => {
      ...
      console.log("here is the file", files[0]);  
    };

    console.log("from upload documents = ", isUploadDocument)
    ...
    return (
        <div className="px-4 lg:px-0">
            ...
            <div className="grid grid-cols-1 gap-4">
                <div>
                    <label htmlFor="childAadhaar">Child Aadhar Card/Birth Certificate( Only for Pg to Class 1)<span className="text-red-500 mr-2">*</span></label>
                    {
                        isUploadDocument ?  (<div className='bg-green-500 text-white p-2 rounded-md'>Documents Uploaded</div>):
