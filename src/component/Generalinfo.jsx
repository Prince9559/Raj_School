...
function Generalinfo() {
  ...
  const [editedField, setEditedField] = useState({ colName: "", colValue: "" });
    ...
    <div className="flex justify-center items-center ">
      <table id="" className="border-collapse w-4/5 shadow-lg bg-white">
        {window.innerWidth < 768 && (
          <thead>
            <tr>
              <th colSpan="3" className="px-4 py-3 bg-red-500 text-white text-center">GENERAL&nbsp; &nbsp;
             INFORMATION</th>
            </tr>
          </thead>
        )}
                  ...
                  {isEditing ? (
                    <div className="flex flex-row gap-2">
                      <button
                        ...
                        type="button"
                        className="flex justify-center items-center h-[2.875rem] w-[2.875rem] text-sm font-bold rounded-lg hover:stroke-white bg-green-200"
                      >
                        Save
                      </button>
                      <button
                        ...
                        type="button"
                        className="flex justify-center items-center h-[2.875rem] w-[2.875rem] text-sm font-semibold rounded-lg hover:stroke-white bg-red-200"
                      >
                        Cancel
                      </button>
                    </div>
                    ...
                    <button
                      onClick={() =>
                        handleEditClick(data.id, data.colName, data.colValue)
                      }
                    >
                      Edit
                    </button>
